...
{
  public:
    SpatialReuse() noexcept = default;
    ~SpatialReuse() = default;

    SpatialReuse(const SpatialReuse &other) = delete;
    SpatialReuse(SpatialReuse &&other) = delete;
    SpatialReuse &operator=(const SpatialReuse &other) = delete;
    SpatialReuse &operator=(SpatialReuse &&other) = delete;
