...
#include <shader_structs/push_constants/restir_di/spatial_reuse.h>
...
StaticArray<vk::DescriptorSetLayout, BindingSetCount - 1> externalDsLayouts(
    const SpatialReuse::InputDSLayouts &dsLayouts)
{
...
bool SpatialReuse::recompileShaders(
...
SpatialReuse::Output SpatialReuse::record(
