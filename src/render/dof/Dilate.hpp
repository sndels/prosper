...
{
  public:
    Dilate() noexcept = default;
    ~Dilate() = default;

    Dilate(const Dilate &other) = delete;
    Dilate(Dilate &&other) = delete;
    Dilate &operator=(const Dilate &other) = delete;
    Dilate &operator=(Dilate &&other) = delete;
    ...
    [[nodiscard]] Output record(
        ...
        ImageHandle tileMinMaxCoC, const scene::Camera &cam,
        uint32_t nextFrame);
